...
function vac_bd_categories()
{
    $categories = [
        [
            "name" => "Citigen Registration (18 and up)",
            "bn_name" => "নাগরিক নিবন্ধন (১৮ বছর ও তদুর্ধ)",
            "min_age" => 18

        ],
        [
            "name" => "Family Planning and Health Ministry employee",
            "bn_name" => "স্বাস্থ্য ও পরিবার কল্যাণ মন্ত্রণালয় এর সকল কর্মকর্তা-কর্মচারী",
            "min_age" => 22
        ],
        [
            "name" => "Approved private and private health and family planning officers-employees",
            "bn_name" => "অনুমোদিত বেসরকারি ও প্রাইভেট স্বাস্থ্য ও পরিবার পরিকল্পনা কর্মকর্তা-কর্মচারী",
            "min_age" => 22
        ],
        [
            "name" => "All government and private health care officers and employees directly involved",
            "bn_name" => "প্রত্যক্ষভাবে সম্পৃক্ত সকল সরকারি ও বেসরকারি স্বাস্থ্য সেবা কর্মকর্তা-কর্মচারী",
            "min_age" => 22
        ],
        [
            "name" => "Heroic freedom fighters and heroines",
            "bn_name" => "বীরমুক্তিযোদ্ধা ও বীরঙ্গনা",
            "min_age" => 60
        ],
        [
            "name" => "Front line law enforcement forces",
            "bn_name" => "সম্মুখ সারির আইন-শৃঙ্খলা রক্ষাকারী বাহিনী",
            "min_age" => 22
        ],
        [
            "name" => "Military forces",
            "bn_name" => "সামরিক বাহিনী",
            "min_age" => 22
        ],
        [
            "name" => "Office essential for running the state",
            "bn_name" => "রাষ্ট্র পরিচালনার নিমিত্ত অপরিহার্য কার্যালয়",
            "min_age" => 22
        ],
        [
            "name" => "Bar Council Registrar Attorney",
            "bn_name" => "বার কাউন্সিলের রেজিস্ট্রার আইনজীবী",
            "min_age" => 22
        ],
        [
            "name" => "Educatonal Institution",
            "bn_name" => "শিক্ষা প্রতিষ্ঠান",
            "min_age" => 12
        ],
        [
            "name" => "Front Line Media worker",
            "bn_name" => "সম্মুখ সারির গণমাধ্যমকর্মী",
            "min_age" => 22
        ],
        [
            "name" => "Elected representatives",
            "bn_name" => "নির্বাচিত জনপ্রতিনিধি",
            "min_age" => 25
        ],
        [
            "name" => "City Corporation and Municipality front row officers-employees",
            "bn_name" => "সিটি কর্পোরেশন ও পৌরসভার সম্মুখ সারির কর্মকর্তা-কর্মচারী",
            "min_age" => 22
        ],
        [
            "name" => "Religious Representatives",
            "bn_name" => "ধর্মীয় প্রতিনিধিগণ (সকল ধর্মের)",
            "min_age" => 18
        ],
        [
            "name" => "A person engaged in cremation",
            "bn_name" => "মৃতদেহ সৎকার কার্যে নিয়োজিত ব্যক্তি",
            "min_age" => 22
        ],
        [
            "name" => "Emergency Electricity , Water, Gas and Fire Service frontline Officers and Staff",
            "bn_name" => "জরুরি বিদ্যুৎ, পানি, গ্যাস, পয়ঃনিষ্কাশন ও ফায়ার সার্ভিস এর সম্মুখ সারির কর্মকর্তা-কর্মচারী",
            "min_age" => 22
        ],
        [
            "name" => "Railway, Airport, Dry Port and Naval Port Government Officers and Staff",
            "bn_name" => "রেল স্টেশন, বিমান বন্দর, স্থল বন্দর ও নৌ বন্দরের সরকারি কর্মকর্তা-কর্মচারী",
            "min_age" => 22,
        ],
        [
            "name" => "Officer and Employees devoted to Emergency Public Service in Districts and Upazilas",
            "bn_name" => "জেলা ও উপজেলাসমূহে জরুরি জনসেবায় সম্পৃক্ত কর্মকর্তা-কর্মচারী",
            "min_age" => 22
        ],
        [
            "name" => "Bank Officers and Staff",
            "bn_name" => "ব্যাংক কর্মকর্তা-কর্মচারী",
            "min_age" => 22
        ],
        [
            "name" => "Farmers",
        ...
        [
            "name" => "National team Player",
            "bn_name" => "জাতীয় দলের খেলোয়াড়",
            "min_age" => 16

        ],
        [
            "name" => "Medical Student",
            "bn_name" => "চিকিৎসা শিক্ষা সংশ্লিষ্ট বিষয়ে ছাত্র ছাত্রী",
            "min_age" => 16
        ],
        [
            "name" => "18 up students",
            "bn_name" => "১৮ বছর বা তদূর্ধ্ব ছাত্র-ছাত্রী",
            "min_age" => 18
        ],
        [
            "name" => "Disabled Person",
            "bn_name" => "প্রতিবন্ধী ব্যক্তি",
            "min_age" => 10
        ]
    ];
    return $categories;
...
function vac_bd_vaccines()
{
    $vaccines = array(
        array('id' => '1', 'name' => 'Moderna', 'org_name' => 'Moderna: Spikevax', 'alt_name' => 'mRNA-1273', 'type' => 'RNA'),
        array('id' => '2', 'name' => 'Pfizer', 'org_name' => 'Pfizer/BioNTech: Comirnaty', 'alt_name' => 'Tozinameran, BNT162b2', 'type' => 'RNA'),
        array('id' => '3', 'name' => 'Sinopharm(Vero Cells)', 'org_name' => 'Sinopharm (Beijing): Covilo', 'alt_name' => 'BBIBP-CorV (Vero Cells)', 'type' => 'Inactivated'),
        array('id' => '4', 'name' => 'Sputnik V', 'org_name' => 'Gamaleya: Sputnik V', 'alt_name' => 'Gam-COVID-Vac', 'type' => 'Non Replicating Viral Vector'),
        array('id' => '5', 'name' => 'Sinovac: CoronaVac',  'org_name' => 'Sinovac: CoronaVac', 'alt_name' => '', 'type' => 'Inactivated'),
        array('id' => '6', 'name' => 'Janssen (Johnson & Johnson)', 'org_name' => 'Janssen (Johnson & Johnson): Ad26.COV2.S', 'alt_name' => 'Ad26COVS1, JNJ-78436735', 'type' => 'Non Replicating Viral Vector'),
        array('id' => '7', 'name' => 'AstraZeneca / Oxford', 'org_name' => 'Serum Institute of India: Covishield (Oxford/ AstraZeneca formulation)', 'alt_name' => '', 'type' => 'Non Replicating Viral Vector'),
    );
    return $vaccines;
}
