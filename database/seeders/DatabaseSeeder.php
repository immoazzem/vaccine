...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($upazilas as $key => $upazila) {
            $all_upazillas = new Upazila();
            $all_upazillas->id = $upazila['id'];
            $all_upazillas->district_id = $upazila['district_id'];
            $all_upazillas->name = $upazila['name'];
            $all_upazillas->bn_name = $upazila['bn_name'];
            $all_upazillas->url = $upazila['url'];
            $all_upazillas->save();
        }
    }
}
